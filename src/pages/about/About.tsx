                ...
                <div className="w-full mx-auto mb-10 py-7">
                    ...
                    <div className="grid-3 gap-4 mb-16">
                        {[
                            ...
                            { image: '/images/dhritiman.webp', name: 'Dhritiman Murti', role: 'Co-founder', desc: 'Dhritiman Murti is the Co-founder of 1EQ, where he leads the in-house technology team and drives the company’s accessibility-first engineering vision. he has served as a director and key tech leader across multiple ventures, bringing strategic insight to product development, system architecture, and user-centric innovation. He ensures that technology at 1EQ not only powers robust exam-preparation platforms but also advances inclusive, accessible technology for diverse user communities.', url: 'https://www.linkedin.com/in/dhritiman-murti-918646125/' },

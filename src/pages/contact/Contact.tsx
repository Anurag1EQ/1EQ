    ...
    <>
      ...
      <section className=" flex items-center justify-center bg-white  font-['DM_Sans']">
        <div className="flex flex-col items-center justify-center w-full">
          <div className="global-width min-h-[400px] md:min-h-[650px] h-auto md:h-[calc(100vh-200px)] flex flex-col items-center justify-center global-border-page w-full mx-auto py-10 md:py-0">
            <div className="px-4 md:px-[36px] w-full flex flex-col max-w-[1400px] mx-auto">
              {/* Light Content */}
              <div className="mx-auto w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-[60px] items-start">
                    ...
                    <div className="mb-8 flex flex-col gap-4">
                      <div className="flex items-start gap-4 pb-4  border-b ">
                        ...
                        <div>
                          ...
                          <a
                            href="mailto:hello@1eq.in"
                            className="text-[15px] theme-text-medium no-underline"
                          >
                            contact@1eq.in
                          </a>
                        </div>
                      ...
                      <div className="flex items-start gap-4 pb-4  border-b">
                        ...
                        <div>
                          ...
                          <p className="text-[15px] theme-text-medium leading-[1.6]">
                            907, OCUS Quantum , Sector-51, Gurgaon
                            <br />
                            Haryana, India
                          </p>
                        </div>
                    ...
                    <div className="pt-6   border-slate-200">
                      ...
                      <div className="flex gap-5">
                        {[
                          {
                            name: "LinkedIn",
                            icon: <TiSocialLinkedin className="text-[22px]" />,
                            url: "https://in.linkedin.com/company/1eq-tech",
                          },
                          // { name: 'Twitter', icon: <FaXTwitter className='text-[18px]' />, url: 'https://x.com/1EQfoundation' },
                          {
                            name: "Telegram",
                            icon: <FaTelegram className="text-[18px]" />,
                            url: "https://t.me/One_EQ",
                          },
                          {
                            name: "YouTube",
                            icon: <FaYoutube className="text-[18px]" />,
                            url: "https://youtube.com/@1-EQ",
                          },
                        ].map((social) => (
                          <a
                            key={social.name}
                  ...
                  <div className="bg-slate-50 p-6 md:p-10">
                    <form>
                      {/* Name and Email Row */}
                      <div className="grid text-[var(--theme-text-medium)] grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div>
                          <label
                            className="block text-sm font-medium 
                                            text-[var(--theme-text-medium)] mb-2"
                          >
                            Your name
                          </label>
                          <input
                          ...
                          />
                          <p className="text-red-500 py-1 text-[14px] h-[22px] leading-none">
                      ...
                      <div className="mt-4 text-decoration-none  text-[var(--theme-text-light)] font-semibold text-[16px] text-center">
                        <p className="  ">
                          ...
                          <Link
                            ...
                            className="text-[var(--theme-text-medium)]   underline"
                          >
                            Terms of Service
                          </Link>{" "}
                          and{" "}

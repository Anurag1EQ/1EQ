            ...
            <section className="min-h-screen bg-white global-width py-10 global-border-page mx-auto global-padding">
                ...
                <div className="w-full mx-auto mb-10 py-7">
                    ...
                    <div className="grid-4 gap-3 mb-16">
                        {[
                            { icon: '/images/target.svg', title: 'Mission-driven', desc: 'Your work directly impacts millions of learners across India' },
                            { icon: '/images/home.svg', title: 'Remote-first', desc: 'Work from anywhere in India. We judge output, not hours.' },
                            { icon: '/images/trending-up.svg', title: 'Growth', desc: 'Small team = big ownership. Grow fast with real responsibility.' },
                    ...
                    <p className="text-[15px] text-[var(--theme-text-medium)] mb-10 text-center max-w-[700px] mx-auto">
                        Don't see a perfect fit? We're always looking for exceptional people. Send your resume to <span className="text-[var(--theme-text-dark)] font-[500]">careers@1eq.in</span>
                    </p>
                    ...
                    {/* Benefits */}
                    <div className="bg-[var(--bg-card)] rounded-[5px] p-7 mb-10 max-w-[900px] mx-auto">
                        <h3 className="text-[18px] font-[500] text-[var(--theme-text-dark)] mb-5">Benefits & Perks</h3>
                        <div className="grid-2 gap-3">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-2">
                                    <span className="text-[14px] text-[var(--theme-text-dark)]">{benefit}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="mb-10 max-w-[900px] mx-auto">
                        <h3 className="text-[18px] font-[500] text-[var(--theme-text-dark)] mb-6 text-center">Our Hiring Process</h3>
                        <div className="flex gap-3">
                            {[
                                ...
                                <div key={i} className="flex-1 text-center">
                                    <div className="w-[35px] h-[35px] rounded-full bg-[var(--bg-card)] text-[var(--theme-text-dark)] flex items-center justify-center font-[500] text-[14px] mx-auto mb-2">
                                        {item.step}
                                    </div>
                                    <h4 className="text-[15px] font-[500] text-[var(--theme-text-dark)] mb-1">{item.title}</h4>
                                    <p className="text-[13px] text-[var(--theme-text-medium)]">{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>

            ...
            <section className="min-h-screen bg-white global-width py-10 global-border-page mx-auto global-padding">
                ...
                <div className="w-full mx-auto mb-10 py-7">
                    <div className="bg-[var(--bg-card)] rounded-[5px] p-7 mb-10">
                        <span className="inline-block bg-[var(--bg-card-light)] text-[var(--theme-text-medium)] px-3 py-1.5 rounded-md text-[12px] font-[400] mb-4">FREE ADVISORY</span>
                        ...
                        <div className="flex items-center gap-4 p-5 bg-white rounded-[5px]">
                            <div>
                    ...
                    <p className="text-[30px] font-lt-remark text-[var(--theme-text-dark)] font-[400] mb-10 text-center leading-[1.3]">
                        Expert services for your product journey
                    </p>

                    <div className="grid-2 gap-4 mb-16">
                        {[
                            { icon: '/images/code.svg', title: 'Custom Development', desc: 'End-to-end product development for EdTech and social impact organizations.' },
                            ...
                            <div key={item.title} className="bg-[var(--bg-card)] rounded-[5px] p-7">
                    ...
                    <div className="grid-2 gap-4 mb-16">
                        {[
                            ...
                            <div key={item.name} className="bg-[var(--bg-card)] rounded-[5px] p-7">
                                <span className="inline-block bg-[var(--bg-card-light)] text-[var(--theme-text-medium)] px-3 py-1 rounded-md text-[12px] font-[400] mb-3">{item.cat}</span>
                    ...
                    <div className="grid-4 gap-3 mb-10">
                        {[
                            ...
                            { step: '02', label: 'Design', desc: 'We architect solutions that fit your needs, timeline, and budget. User-centered, accessible-first.', icon: '/images/pen.svg' },
                            ...
                            <div key={item.step} className="p-6 rounded-2xl flex flex-col items-center">
                                <div className="w-[30px] mb-3"><img src={item.icon} className='h-full w-full object-contain' alt="" /></div>
                                <div className="text-[12px] text-[var(--theme-text-medium)] font-[400] mb-1">{item.step}</div>

        ...
        <>
            ...
            <section className="min-h-screen bg-white global-width py-10 global-border-page mx-auto global-padding">
                ...
                <div className="w-full mx-auto mb-10 py-7">
                    ...
                    <p className="text-[30px] text-[var(--theme-text-dark)] font-[400] font-lt-remark leading-[1.3] mb-4 text-center">
                ...
                <div className="w-full mx-auto mt-10">
                    ...
                    <p className="text-[30px] font-lt-remark text-[var(--theme-text-dark)] font-[400] mb-10 text-center">

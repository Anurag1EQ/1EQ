    ...
    return (
        <nav className="absolute top-0 left-0 right-0 flex z-[100]">
            <div className="flex items-center justify-between gap-5 px-4 md:px-8 py-4 md:py-6 global-width mx-auto w-full">
                <Link to="/" className="w-[80px] cursor-pointer shrink-0" aria-label="1EQ Home">
                ...
                <div className="hidden md:flex items-center gap-3">
                    <Link
                        to="/contact"
                        className="px-[18px] hover:bg-[var(--border-light)] duration-300 py-[12px] font-[500] cursor-pointer text-[16px] text-[var(--text-light)] bg-[var(--button-dark)] outline-none border border-[var(--border-medium)] backdrop-blur-[4px]"
                    >
                        Get in touch
                    </Link>
                </div>
                ...
                <button
                    type="button"
                    className="nav-menu-btn md:hidden p-2"

      ...
      <div className="relative h-full w-full global-width mx-auto border-l-[1px] border-[var(--border-light)] border-r-[1px]">
        <div className="image-wrapper absolute h-[60%]  flex items-center w-full top-0 left-0 ">
          <img
            ...
            alt=""
            className="w-full h-full object-cover block bg-center"
          />
        </div>

        <div className="h-full w-full  flex flex-col gap-[50px]   relative justify-between text-white pt-8 md:pt-[60px] px-4 md:px-[36px]   pb-6 md:pb-[36px]">
          <div className="flex flex-col gap-4 md:gap-[24px] max-w-[520px]">
            <p className="text-[16px] text-[var(--text-light)]">GET STARTED</p>
            <p className="text-[28px] sm:text-[36px] md:text-[52px] text-[var(--text-light)] font-[400] font-lt-remark leading-[1.1]">
              Ready to build something that matters?
            </p>
            <p className="text-[16px] text-[var(--text-medium)] leading-[1.5]">
              We partner with organizations that share our mission to make
            ...
            <div className="footer-grid mb-4">
              <div className="flex flex-col gap-5">
                ...
                <p className="text-[var(--text-medium)] text-[15px] leading-[1.4]">
                  Learning technology for underserved India.
                  <br />
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    },
                    {
                      name: "YouTube",
                      icon: <FaYoutube className="text-[18px]" />,
                      url: "https://www.youtube.com/@1Math.1EQ",
                    },
                  ].map((social) => (
                    <a
                      key={social.name}

...
- **Details:**
  - `global-padding global-padding-mobile `: 110px → 24px (768px) → 16px (480px). Affects About, Technology, Services, Products, Careers, Privacy, Terms, Refund, Shipping, and several sections.
...
- **Padding:**  
  `px-4 md:px-[36px]`, `p-6 md:p-10`, etc. Match existing `global-padding global-padding-mobile ` breakpoints where relevant.
- **Min heights:**  
...
- **`index.css`:** `480px`, `768px`, `1024px` for `.grid-*`, `.section-padding`, `.footer-grid`, `.global-padding global-padding-mobile `, etc.
...
1. Use `global-width` and `global-padding global-padding-mobile ` (or equivalent) so layout respects existing responsive rules.
